...
/**
 * Component Trang Bảng điều khiển chính (DashboardPages).
      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-6 mb-6">
        ...
        <div className="lg:col-span-1">
          <Card 
            radius="xl"
            p="md"
            className="shadow-xs border border-zinc-100 overflow-hidden flex flex-col justify-between h-full bg-white font-sans"
            style={{ minHeight: 220 }}
          >
            ...
            <div className="flex flex-col items-center justify-center my-6 flex-1">
              <span 
                className="text-5xl font-black text-[#52C41A] tracking-tight leading-none font-sans"
                style={{ fontFamily: 'var(--font-k2d)' }}
              >
            ...
            <a 
              ...
              className="flex items-center justify-between border-t border-zinc-100 pt-3 text-xs text-zinc-500 font-bold hover:text-[#1f5ca9] w-full no-underline"
            >
        ...
        <div className="lg:col-span-1">
          ...
          >
            ...
            <div className="flex flex-col items-center justify-center my-6 flex-1">
              <span 
                className="text-5xl font-black text-[#805AD5] tracking-tight leading-none font-sans"
                style={{ fontFamily: 'var(--font-k2d)' }}
              >
